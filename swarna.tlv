...
\TLV team_myteam_viz(/_top, _team_num)
   ...
   \viz_js
      ...
      render() {
         ...
         // For example...
         const destroyed = (this.sigVal("team_myteam.destroyed").asInt() >> this.getIndex("ship")) & 1;
         return [
...
\TLV team_myteam(/_top)
   m5+verilog_wrapper(/_top, myteam)
