...
\TLV team_team2_viz(/_top, _team_num)
   ...
   \viz_js
      ...
      render() {
         ...
         // For example...
         const destroyed = (this.sigVal("team_team2.destroyed").asInt() >> this.getIndex("ship")) & 1;
         return [
